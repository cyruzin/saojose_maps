...
class Dashboard extends Component<{}, State> {
  ...
  componentDidMount(): void {
    const {markerConfig, talhoes304050} = this.state

    if (!markerConfig && !talhoes304050) this.clearArea()
  }
  ...
  floatHandler = (name: string): void => {
    ...
    return Actions.replace(name, this.state)
  }
        ...
        {area.length > 1 && (
          <TouchableHighlight style={styles.areaBox} onPress={this.clearArea}>
            <Text style={styles.areaText}>
              Colentando área: {area.length} coletadas
            </Text>
          </TouchableHighlight>
        )}
          ...
          <View
            ...
            <View style={{flexDirection: 'row'}}>
              <CheckBox
                value={talhoes304050}
                onValueChange={() =>
                  this.setState({talhoes304050: !talhoes304050})
                }
              />
              <Text
                style={{
                ...
                Tapacura/Caluanda/Cana Brava/Limeirinha/Margi/Nova
                Esperanca/Bringas/Tabocas/Sao Pedro/Sao Paulo
              </Text>
            </View>
            ...
            <View style={{flexDirection: 'row'}}>
              <CheckBox
                value={talhoes606162}
                onValueChange={() =>
                  this.setState({talhoes606162: !talhoes606162})
                }
              />
              <Text
                style={{
            ...
            <View style={{flexDirection: 'row'}}>
              <CheckBox
                value={talhoes636465}
                onValueChange={() =>
                  this.setState({talhoes636465: !talhoes636465})
                }
              />
              <Text
                style={{
            ...
            <View style={{flexDirection: 'row'}}>
              <CheckBox
                value={talhoes666768}
                onValueChange={() =>
                  this.setState({talhoes666768: !talhoes666768})
                }
              />
              <Text
                style={{
            ...
            <View style={{flexDirection: 'row'}}>
              <CheckBox
                value={talhoes747778}
                onValueChange={() =>
                  this.setState({talhoes747778: !talhoes747778})
                }
              />
              <Text
                style={{
